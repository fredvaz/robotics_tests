...
% T0_1
Ti(:,:,1) = [ -sin(th1)  0 cos(th1) -10*sin(th1);
               cos(th1)  0 sin(th1)  10*cos(th1);
                      0  1        0           5; 
                      0  0        0           1  ];
% T1_2
...
FE_Eapp = simplify( RG_0 * F0_Eapp );
FE_E = -FE_Eapp;

Bin = simplify( Jac_E' * FE_Eapp )
...
%Bin_ = subs(Bin, [fy wx th1 th2 d], [-1 -1 pi/2 pi/6 20])

T0_G_ = subs(T0_G, [th1 th2 d], [pi/2 pi/6 20])


FE_E = subs(FE_E, [fy wx th1 th2 d], [-1 -1 pi/2 pi/6 20])

R2_E = subs(Ti(1:3,1:3,3), d, 20)
f2_2 = R2_E * FE_E(1:3)

bin2_3 = R2_E * FE_E(4:end)% + [0 0 20]'*f2_2

%%
R1_2 = subs(Ti(1:3,1:3,2), th2, pi/6)
f1_1 = R1_2 * f2_2

bin1_2 = R1_2 * bin2_3% + [0 0 0]'*f1_1

%%
R0_1 = subs(Ti(1:3,1:3,1), th1, pi/2)
f0_0 = R0_1 * f1_1

bin1_2 = R0_1 * f0_0% + [10 0 5]'*f0_0
